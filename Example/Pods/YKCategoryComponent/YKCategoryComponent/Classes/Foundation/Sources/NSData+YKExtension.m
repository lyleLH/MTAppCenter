...
@implementation NSData (YKExtension)
...
- (NSData *)yk_base64EncodedData {
    return [[self yk_base64Encoded] dataUsingEncoding:NSUTF8StringEncoding];
}
...
- (NSData *)yk_base64DecodedData {
    NSString *string = [NSString yk_stringWithData:self encoding:NSUTF8StringEncoding];
    if(string == nil) {
        return nil;
    }
    if([string length] == 0) {
...
- (NSString *)yk_base64Decoded {
    return [NSString yk_stringWithData:[self yk_base64DecodedData] encoding:NSUTF8StringEncoding];
}
