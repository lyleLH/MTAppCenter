...
//MARK:-
//MARK:- 高度定制化的加边 方法
//MARK:- 例子 ： view.ykBorder.bottom.width(0.333333).color(UIColorFromRGB(0xF2F2F2)).leftEdge(15.5).rightEdge(20);
//MARK:-
////////////////////////////////////////////////////////////////

@interface YKBorderSettings : NSObject
...
// 适用于 autoLayout 的加边方法
@interface YKBorder : NSObject
