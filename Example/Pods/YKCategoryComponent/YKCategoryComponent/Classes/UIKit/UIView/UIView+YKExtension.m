...
@implementation UIView (YKDebug)


- (void)yk_bordering
{
    [self borderOfColor:[UIColor yk_randomColor] andWidth:1];
}
...
- (void)yk_borderingSubviews
{
    [self propagateSelectorToSubviews:@selector(yk_bordering) withObject:nil];
}

- (void)yk_debugingView
{
    [self yk_bordering];
...
- (void)yk_debugingSubviews
{
    [self propagateSelectorToSubviews:@selector(yk_debugingView) withObject:nil];
}
...
- (void)yk_addRounderCornerWithRadius:(CGFloat)radius size:(CGSize)size
{
...
/// @param bgColor 背景颜色
- (CAShapeLayer *)yk_setTopCornerWithRadius:(CGFloat)cornerRadius bgColor:(UIColor *)bgColor {
...
/// @param cornerRadius radius
/// @param bgColor 背景颜色
- (CAShapeLayer *)yk_setBottomCornerWithRadius:(CGFloat)cornerRadius bgColor:(UIColor *)bgColor {
    CAShapeLayer *layer = CAShapeLayer.layer;
...
/// @param cornerRadius radius
/// @param bgColor 背景颜色
- (CAShapeLayer *)yk_setRoundCornerWithRadius:(CGFloat)cornerRadius bgColor:(UIColor *)bgColor {
    CAShapeLayer *layer = CAShapeLayer.layer;
